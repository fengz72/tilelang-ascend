...
from sparse_fa_gm import high_perf_sparse_attn_wrapper
...
def main():
    ...
    parser.add_argument("--acc-seeds", type=int, default=1, help="精度测试随机种子数")
    parser.add_argument("--acc-repeat", type=int, default=1, help="每个种子下重复跑次数")
    ...
    for idx in indices:
        ...
        if args.mode == "accuracy":
            ...
            print(
                ...
                f"(seeds={args.acc_seeds}, repeat={args.acc_repeat}), "
