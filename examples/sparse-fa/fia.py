...
def run_fia_once(q_input, k_input, v_input, atten_mask,
...
def run_fia_timed(q_input, k_input, v_input, atten_mask,
                  actual_seq_lengths, scale, warmup=5, repeat=20):
    ...
    for _ in range(warmup):
        run_fia_once(q_input, k_input, v_input, atten_mask,
                     actual_seq_lengths, scale)
...
if __name__ == "__main__":
    q_input, k_input, v_input, atten_mask, actual_seq_lengths, scale = build_fia_inputs(
        batch_configs, rules, D, num_heads
    )
