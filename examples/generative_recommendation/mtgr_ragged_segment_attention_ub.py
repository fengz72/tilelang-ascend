# msprof op --kernel-name="main_kernel" --output="./log" python mtgr_ragged_segment_attention_ub.py
# msprof op simulator --soc-version=Ascend910B2 --kernel-name="main_kernel" --output="./log" python mtgr_ragged_segment_attention_ub.py
# msprof op simulator --soc-version=Ascend910B2 --kernel-name="main_kernel" --core-id=0 --timeout=60 --output="./log" python mtgr_ragged_segment_attention_ub.py
            ...
            T.annotate_address(
                {
                    ...
                    + half_M * block_N * 4
                    + half_M * 4 * 2,
                    segment_offsets_ub: half_M * dim * 4
                    + num_stages * half_M * 4 * 2
                    + half_M * 12
                    + half_M * block_N * 8
                    + half_M * block_N * 4
                    + half_M * 4 * 3,
                    segment_rules_ub: half_M * dim * 4
                    + num_stages * half_M * 4 * 2
                    + half_M * 12
                    + half_M * block_N * 8
                    + half_M * block_N * 4
